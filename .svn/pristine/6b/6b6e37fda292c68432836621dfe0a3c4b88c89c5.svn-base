 ...
 */
@Slf4j
public class HxRestTemplate extends RestTemplate {

	private DiscoveryClient discoveryClient;

	public HxRestTemplate(DiscoveryClient discoveryClient) {
	...
	/**
	 * 方法实现说明:把微服务名称 去注册中心拉取对应IP进行调用 http://product-center/selectProductInfoById/1
	 * 
	 * @author:smlz
	 * @param url:请求的url
	 * @return:
